! function() {
    ...
    e.version = "2.1.4", e.utils = {}, e.utils.warn = function(e) {
            return function(t) {
            ...
            var e = {
                ...
                T = function(r) {
                    ...
                    if ("y" == (S = r.substr(0, 1)) && (r = S.toUpperCase() + r.substr(1)), b = u, P = l, b.test(r) ? r = r.replace(b, "$1$2") : P.test(r) && (r = r.replace(P, "$1$2")), b = d, P = h, b.test(r)) {
                        var O = b.exec(r);
                        (b = n).test(O[1]) && (b = c, r = r.replace(b, ""))
                    } else P.test(r) && (i = (O = P.exec(r))[1], (P = a).test(i) && (r = i, E = p, I = y, (P = f).test(r) ? r += "e" : E.test(r) ? (b = c, r = r.replace(b, "")) : I.test(r) && (r += "e")));
                    return (b = m).test(r) && (r = (i = (O = b.exec(r))[1]) + "i"), (b = g).test(r) && (i = (O = b.exec(r))[1], T = O[2], (b = n).test(i) && (r = i + e[T])), (b = x).test(r) && (i = (O = b.exec(r))[1], T = O[2], (b = n).test(i) && (r = i + t[T])), b = v, P = w, b.test(r) ? (i = (O = b.exec(r))[1], (b = s).test(i) && (r = i)) : P.test(r) && (i = (O = P.exec(r))[1] + O[2], (P = s).test(i) && (r = i)), (b = k).test(r) && (i = (O = b.exec(r))[1], P = o, E = L, ((b = s).test(i) || P.test(i) && !E.test(i)) && (r = i)), b = Q, P = s, b.test(r) && P.test(r) && (b = c, r = r.replace(b, "")), "y" == S && (r = S.toLowerCase() + r.substr(1)), r
                };
            return function(e) {
                return e.update(T)
            }
            ...
            for (I = 0; I < r.clauses.length; I++) {
                ...
                for (var u = 0; u < a.length; u++) {
                    var l = a[u];
                    o.term = l;
                    for (var d = e.TokenSet.fromClause(o), h = this.tokenSet.intersect(d).toArray(), c = 0; c < h.length; c++)
                        for (var f = h[c], p = this.invertedIndex[f], y = p._index, m = 0; m < o.fields.length; m++) {
                            var g = o.fields[m],
                                x = p[g],
                                v = Object.keys(x),
                                w = f + "/" + g;
                            if (void 0 === n[g] && (n[g] = new e.Vector), n[g].upsert(y, 1 * o.boost, function(e, t) {
                                    return e + t
                                }), !s[w]) {
                                for (var k = 0; k < v.length; k++) {
                                    var Q, L = v[k],
                                        T = new e.FieldRef(L, g),
                                        S = x[L];
                                    void 0 === (Q = i[T]) ? i[T] = new e.MatchData(f, g, S) : Q.add(f, l, S)
                                }
                                s[w] = !0
                            }
                        }
            ...
            for (var b = Object.keys(i), P = [], E = Object.create(null), I = 0; I < b.length; I++) {
                var O, F = e.FieldRef.fromString(b[I]),
                    R = F.docRef,
                    _ = this.fieldVectors[F],
                    N = n[F.fieldName].similarity(_);
                if (void 0 !== (O = E[R])) O.score += N, O.matchData.combine(i[F]);
                else {
                    var C = {
                        ref: R,
                        score: N,
            ...
            for (var t = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, n = Object.create(null), s = 0; s < i; s++) {
                for (var o = e.FieldRef.fromString(r[s]), a = o.fieldName, u = this.fieldLengths[o], l = new e.Vector, d = this.fieldTermFrequencies[o], h = Object.keys(d), c = h.length, f = 0; f < c; f++) {
                    var p, y, m, g = h[f],
                        x = d[g],
                        v = this.invertedIndex[g]._index;
                    void 0 === n[g] ? (p = e.idf(this.invertedIndex[g], this.documentCount), n[g] = p) : p = n[g], y = p * ((this._k1 + 1) * x) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + x), m = Math.round(1e3 * y) / 1e3, l.insert(v, m)
                }
                t[o] = l
            }
            this.fieldVectors = t
            ...
            this.metadata = Object.create(null), this.metadata[e] = Object.create(null), this.metadata[e][t] = i
